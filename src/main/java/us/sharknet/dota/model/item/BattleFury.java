...
public final class BattleFury extends Item {

    private static BattleFury instance;
    ...
    private BattleFury() {
        ...
        cleave_radius = 280;
        components = new String[]{"item_broadsword","item_claymore","item_pers","item_quelling_blade"};
        consumable = false;
        initialCharges = 0;
    ...
    public static BattleFury instance() {
        if( instance == null ){
            instance = new BattleFury();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BattleFury))
            return false;
        if (object == this)
            return true;
        BattleFury otherObject = (BattleFury) object;
