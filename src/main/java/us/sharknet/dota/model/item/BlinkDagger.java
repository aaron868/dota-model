...
public final class BlinkDagger extends Item {

    private static BlinkDagger instance;
    ...
    public static BlinkDagger instance() {
        if( instance == null ){
            instance = new BlinkDagger();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BlinkDagger))
            return false;
        if (object == this)
            return true;
        BlinkDagger otherObject = (BlinkDagger) object;
