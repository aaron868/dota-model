...
public final class Dagon1 extends Item {

    private static Dagon1 instance;
    ...
    private Dagon1() {
        ...
        bonus_intellect = 13;
        chargeable = false;
        components = new String[]{"item_staff_of_wizardry","item_null_talisman","item_recipe_dagon"};
        consumable = false;
        damage = 400;
        damage_delay = 0;
        initialCharges = 0;
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof Dagon1))
            return false;
        if (object == this)
            return true;
        Dagon1 otherObject = (Dagon1) object;
