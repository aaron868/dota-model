...
public final class Dagon4 extends Item {

    private static Dagon4 instance;
    ...
    private Dagon4() {
        ...
        bonus_intellect = 22;
        chargeable = false;
        components = new String[]{"item_dagon_3","item_recipe_dagon_4"};
        consumable = false;
        damage = 700;
        damage_delay = 0;
        initialCharges = 0;
        localizedName = "Dagon 4";
        maxCharges = 0;
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof Dagon4))
            return false;
        if (object == this)
            return true;
        Dagon4 otherObject = (Dagon4) object;
