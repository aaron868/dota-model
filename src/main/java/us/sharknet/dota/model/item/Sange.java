...
public final class Sange extends Item {
    ...
    private Sange() {
        ...
        bonus_strength = 16;
        chargeable = false;
        components = new String[]{"item_ogre_axe","item_belt_of_strength","item_recipe_sange"};
        consumable = false;
        initialCharges = 0;
        localizedName = "Sange";
        ...
        maxCharges = 0;
        partOf = new String[]{"item_sange_and_yasha","item_heavens_halberd","item_silver_edge"};
        placeable = false;
        placeableDuration = 0;
        placeholder = false;
        quantity = 1;
