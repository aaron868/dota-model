...
public final class BadguysFillers extends NpcUnit {

    private static BadguysFillers instance;
    ...
    private BadguysFillers() {
        ...
        localizedName = "Dire Building";
    }

    public static BadguysFillers instance() {
        if( instance == null ){
            instance = new BadguysFillers();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysFillers))
            return false;
        if (object == this)
            return true;
        BadguysFillers otherObject = (BadguysFillers) object;
