...
public final class BadguysFort extends NpcUnit {

    private static BadguysFort instance;
    ...
    public static BadguysFort instance() {
        if( instance == null ){
            instance = new BadguysFort();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysFort))
            return false;
        if (object == this)
            return true;
        BadguysFort otherObject = (BadguysFort) object;
