...
public final class BadguysMeleeRaxBot extends NpcUnit {

    private static BadguysMeleeRaxBot instance;
    ...
    private BadguysMeleeRaxBot() {
        ...
        localizedName = "Dire Bottom Melee Barracks";
    }

    public static BadguysMeleeRaxBot instance() {
        if( instance == null ){
            instance = new BadguysMeleeRaxBot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysMeleeRaxBot))
            return false;
        if (object == this)
            return true;
        BadguysMeleeRaxBot otherObject = (BadguysMeleeRaxBot) object;
