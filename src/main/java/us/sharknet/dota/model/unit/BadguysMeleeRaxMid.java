...
public final class BadguysMeleeRaxMid extends NpcUnit {

    private static BadguysMeleeRaxMid instance;
    ...
    private BadguysMeleeRaxMid() {
        ...
        localizedName = "Dire Mid Melee Barracks";
    }

    public static BadguysMeleeRaxMid instance() {
        if( instance == null ){
            instance = new BadguysMeleeRaxMid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysMeleeRaxMid))
            return false;
        if (object == this)
            return true;
        BadguysMeleeRaxMid otherObject = (BadguysMeleeRaxMid) object;
