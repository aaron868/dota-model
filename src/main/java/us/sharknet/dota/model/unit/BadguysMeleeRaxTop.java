...
public final class BadguysMeleeRaxTop extends NpcUnit {

    private static BadguysMeleeRaxTop instance;
    ...
    private BadguysMeleeRaxTop() {
        ...
        localizedName = "Dire Top Melee Barracks";
    }

    public static BadguysMeleeRaxTop instance() {
        if( instance == null ){
            instance = new BadguysMeleeRaxTop();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysMeleeRaxTop))
            return false;
        if (object == this)
            return true;
        BadguysMeleeRaxTop otherObject = (BadguysMeleeRaxTop) object;
