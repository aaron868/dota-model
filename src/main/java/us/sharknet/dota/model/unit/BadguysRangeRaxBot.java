...
public final class BadguysRangeRaxBot extends NpcUnit {

    private static BadguysRangeRaxBot instance;
    ...
    public static BadguysRangeRaxBot instance() {
        if( instance == null ){
            instance = new BadguysRangeRaxBot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysRangeRaxBot))
            return false;
        if (object == this)
            return true;
        BadguysRangeRaxBot otherObject = (BadguysRangeRaxBot) object;
