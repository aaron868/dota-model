...
public final class BadguysRangeRaxMid extends NpcUnit {

    private static BadguysRangeRaxMid instance;
    ...
    private BadguysRangeRaxMid() {
        ...
        localizedName = "Dire Mid Ranged Barracks";
    }

    public static BadguysRangeRaxMid instance() {
        if( instance == null ){
            instance = new BadguysRangeRaxMid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysRangeRaxMid))
            return false;
        if (object == this)
            return true;
        BadguysRangeRaxMid otherObject = (BadguysRangeRaxMid) object;
