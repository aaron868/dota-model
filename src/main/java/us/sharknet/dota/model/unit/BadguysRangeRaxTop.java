...
public final class BadguysRangeRaxTop extends NpcUnit {

    private static BadguysRangeRaxTop instance;
    ...
    private BadguysRangeRaxTop() {
        ...
        localizedName = "Dire Top Ranged Barracks";
    }

    public static BadguysRangeRaxTop instance() {
        if( instance == null ){
            instance = new BadguysRangeRaxTop();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysRangeRaxTop))
            return false;
        if (object == this)
            return true;
        BadguysRangeRaxTop otherObject = (BadguysRangeRaxTop) object;
