...
public final class BadguysSiege extends NpcUnit {

    private static BadguysSiege instance;
    ...
    public static BadguysSiege instance() {
        if( instance == null ){
            instance = new BadguysSiege();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysSiege))
            return false;
        if (object == this)
            return true;
        BadguysSiege otherObject = (BadguysSiege) object;
