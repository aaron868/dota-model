...
public final class BadguysSiegeUpgradedMega extends NpcUnit {

    private static BadguysSiegeUpgradedMega instance;
    ...
    private BadguysSiegeUpgradedMega() {
        armorPhysical = 0;
        ...
        healthBarOffset = 160;
        key = "npc_dota_badguys_siege_upgraded_mega";
        level = 4;
        ...
        localizedName = "Dire Mega Siege Creep";
    }

    public static BadguysSiegeUpgradedMega instance() {
        if( instance == null ){
            instance = new BadguysSiegeUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysSiegeUpgradedMega))
            return false;
        if (object == this)
            return true;
        BadguysSiegeUpgradedMega otherObject = (BadguysSiegeUpgradedMega) object;
