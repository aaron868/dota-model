...
public final class BadguysTower1Bot extends NpcUnit {

    private static BadguysTower1Bot instance;
    ...
    private BadguysTower1Bot() {
        ...
        localizedName = "Dire Bottom Tier 1 Tower";
    }

    public static BadguysTower1Bot instance() {
        if( instance == null ){
            instance = new BadguysTower1Bot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower1Bot))
            return false;
        if (object == this)
            return true;
        BadguysTower1Bot otherObject = (BadguysTower1Bot) object;
