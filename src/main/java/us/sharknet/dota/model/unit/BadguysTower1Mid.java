...
public final class BadguysTower1Mid extends NpcUnit {

    private static BadguysTower1Mid instance;
    ...
    private BadguysTower1Mid() {
        ...
        localizedName = "Dire Mid Tier 1 Tower";
    }

    public static BadguysTower1Mid instance() {
        if( instance == null ){
            instance = new BadguysTower1Mid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower1Mid))
            return false;
        if (object == this)
            return true;
        BadguysTower1Mid otherObject = (BadguysTower1Mid) object;
