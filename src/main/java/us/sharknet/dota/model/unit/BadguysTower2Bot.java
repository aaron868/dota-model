...
public final class BadguysTower2Bot extends NpcUnit {

    private static BadguysTower2Bot instance;
    ...
    private BadguysTower2Bot() {
        ...
        localizedName = "Dire Bottom Tier 2 Tower";
    }

    public static BadguysTower2Bot instance() {
        if( instance == null ){
            instance = new BadguysTower2Bot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower2Bot))
            return false;
        if (object == this)
            return true;
        BadguysTower2Bot otherObject = (BadguysTower2Bot) object;
