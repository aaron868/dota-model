...
public final class BadguysTower2Mid extends NpcUnit {

    private static BadguysTower2Mid instance;
    ...
    private BadguysTower2Mid() {
        ...
        localizedName = "Dire Mid Tier 2 Tower";
    }

    public static BadguysTower2Mid instance() {
        if( instance == null ){
            instance = new BadguysTower2Mid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower2Mid))
            return false;
        if (object == this)
            return true;
        BadguysTower2Mid otherObject = (BadguysTower2Mid) object;
