...
public final class BadguysTower2Top extends NpcUnit {

    private static BadguysTower2Top instance;
    ...
    private BadguysTower2Top() {
        ...
        localizedName = "Dire Top Tier 2 Tower";
    }

    public static BadguysTower2Top instance() {
        if( instance == null ){
            instance = new BadguysTower2Top();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower2Top))
            return false;
        if (object == this)
            return true;
        BadguysTower2Top otherObject = (BadguysTower2Top) object;
