...
public final class BadguysTower3Bot extends NpcUnit {

    private static BadguysTower3Bot instance;
    ...
    private BadguysTower3Bot() {
        ...
        localizedName = "Dire Bottom Tier 3 Tower";
    }

    public static BadguysTower3Bot instance() {
        if( instance == null ){
            instance = new BadguysTower3Bot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower3Bot))
            return false;
        if (object == this)
            return true;
        BadguysTower3Bot otherObject = (BadguysTower3Bot) object;
