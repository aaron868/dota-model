...
public final class BadguysTower3Top extends NpcUnit {

    private static BadguysTower3Top instance;
    ...
    private BadguysTower3Top() {
        ...
        localizedName = "Dire Top Tier 3 Tower";
    }

    public static BadguysTower3Top instance() {
        if( instance == null ){
            instance = new BadguysTower3Top();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower3Top))
            return false;
        if (object == this)
            return true;
        BadguysTower3Top otherObject = (BadguysTower3Top) object;
