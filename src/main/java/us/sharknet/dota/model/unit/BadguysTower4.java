...
public final class BadguysTower4 extends NpcUnit {

    private static BadguysTower4 instance;
    ...
    public static BadguysTower4 instance() {
        if( instance == null ){
            instance = new BadguysTower4();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BadguysTower4))
            return false;
        if (object == this)
            return true;
        BadguysTower4 otherObject = (BadguysTower4) object;
