...
public final class BeastmasterBoar2 extends NpcUnit {

    private static BeastmasterBoar2 instance;
    ...
    private BeastmasterBoar2() {
        ...
        localizedName = "Boar Level 2";
    }

    public static BeastmasterBoar2 instance() {
        if( instance == null ){
            instance = new BeastmasterBoar2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BeastmasterBoar2))
            return false;
        if (object == this)
            return true;
        BeastmasterBoar2 otherObject = (BeastmasterBoar2) object;
