...
public final class BeastmasterBoar3 extends NpcUnit {

    private static BeastmasterBoar3 instance;
    ...
    private BeastmasterBoar3() {
        ...
        healthBarOffset = 125;
        isSummoned = 1;
        key = "npc_dota_beastmaster_boar_3";
        level = 5;
        ...
        localizedName = "Boar Level 3";
    }

    public static BeastmasterBoar3 instance() {
        if( instance == null ){
            instance = new BeastmasterBoar3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BeastmasterBoar3))
            return false;
        if (object == this)
            return true;
        BeastmasterBoar3 otherObject = (BeastmasterBoar3) object;
