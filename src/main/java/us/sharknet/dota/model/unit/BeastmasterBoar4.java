...
public final class BeastmasterBoar4 extends NpcUnit {

    private static BeastmasterBoar4 instance;
    ...
    private BeastmasterBoar4() {
        ...
        healthBarOffset = 125;
        isSummoned = 1;
        key = "npc_dota_beastmaster_boar_4";
        level = 5;
        ...
        localizedName = "Boar Level 4";
    }

    public static BeastmasterBoar4 instance() {
        if( instance == null ){
            instance = new BeastmasterBoar4();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BeastmasterBoar4))
            return false;
        if (object == this)
            return true;
        BeastmasterBoar4 otherObject = (BeastmasterBoar4) object;
