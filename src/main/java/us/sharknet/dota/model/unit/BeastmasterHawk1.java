...
public final class BeastmasterHawk1 extends NpcUnit {

    private static BeastmasterHawk1 instance;
    ...
    private BeastmasterHawk1() {
        ...
        wakesNeutrals = 0;
        localizedName = "Hawk Level 1";
    }

    public static BeastmasterHawk1 instance() {
        if( instance == null ){
            instance = new BeastmasterHawk1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BeastmasterHawk1))
            return false;
        if (object == this)
            return true;
        BeastmasterHawk1 otherObject = (BeastmasterHawk1) object;
