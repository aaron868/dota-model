...
public final class BeastmasterHawk4 extends NpcUnit {

    private static BeastmasterHawk4 instance;
    ...
    private BeastmasterHawk4() {
        ...
        wakesNeutrals = 0;
        localizedName = "Hawk Level 4";
    }

    public static BeastmasterHawk4 instance() {
        if( instance == null ){
            instance = new BeastmasterHawk4();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BeastmasterHawk4))
            return false;
        if (object == this)
            return true;
        BeastmasterHawk4 otherObject = (BeastmasterHawk4) object;
