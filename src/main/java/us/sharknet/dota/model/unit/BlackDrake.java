...
public final class BlackDrake extends NpcUnit {

    private static BlackDrake instance;
    ...
    public static BlackDrake instance() {
        if( instance == null ){
            instance = new BlackDrake();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BlackDrake))
            return false;
        if (object == this)
            return true;
        BlackDrake otherObject = (BlackDrake) object;
