...
public final class BlueDragonspawnSorcerer extends NpcUnit {

    private static BlueDragonspawnSorcerer instance;

    private final BlueDragonspawnSorcererEvasion ability1;
    ...
    public static BlueDragonspawnSorcerer instance() {
        if( instance == null ){
            instance = new BlueDragonspawnSorcerer();
        }
        return instance;
    }

    public BlueDragonspawnSorcererEvasion getAbility1() {
        return ability1;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BlueDragonspawnSorcerer))
            return false;
        if (object == this)
            return true;
        BlueDragonspawnSorcerer otherObject = (BlueDragonspawnSorcerer) object;
