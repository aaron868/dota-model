...
public final class BrewmasterEarth1 extends NpcUnit {

    private static BrewmasterEarth1 instance;
    ...
    private BrewmasterEarth1() {
        ...
        isAncient = 1;
        isSummoned = 0;
        key = "npc_dota_brewmaster_earth_1";
        level = 7;
        ...
        localizedName = "Brewmaster Earth Spirit Level 1";
    }

    public static BrewmasterEarth1 instance() {
        if( instance == null ){
            instance = new BrewmasterEarth1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterEarth1))
            return false;
        if (object == this)
            return true;
        BrewmasterEarth1 otherObject = (BrewmasterEarth1) object;
