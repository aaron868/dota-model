...
public final class BrewmasterEarth2 extends NpcUnit {

    private static BrewmasterEarth2 instance;
    ...
    public static BrewmasterEarth2 instance() {
        if( instance == null ){
            instance = new BrewmasterEarth2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterEarth2))
            return false;
        if (object == this)
            return true;
        BrewmasterEarth2 otherObject = (BrewmasterEarth2) object;
