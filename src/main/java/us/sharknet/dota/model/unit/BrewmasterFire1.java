...
public final class BrewmasterFire1 extends NpcUnit {

    private static BrewmasterFire1 instance;
    ...
    private BrewmasterFire1() {
        ...
        isAncient = 1;
        isSummoned = 0;
        key = "npc_dota_brewmaster_fire_1";
        level = 7;
        modelScale = .85;
        ...
        localizedName = "Brewmaster Fire Spirit Level 1";
    }

    public static BrewmasterFire1 instance() {
        if( instance == null ){
            instance = new BrewmasterFire1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterFire1))
            return false;
        if (object == this)
            return true;
        BrewmasterFire1 otherObject = (BrewmasterFire1) object;
