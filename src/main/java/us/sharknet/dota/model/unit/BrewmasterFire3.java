...
public final class BrewmasterFire3 extends NpcUnit {

    private static BrewmasterFire3 instance;
    ...
    private BrewmasterFire3() {
        ...
        localizedName = "Brewmaster Fire Spirit Level 3";
    }

    public static BrewmasterFire3 instance() {
        if( instance == null ){
            instance = new BrewmasterFire3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterFire3))
            return false;
        if (object == this)
            return true;
        BrewmasterFire3 otherObject = (BrewmasterFire3) object;
