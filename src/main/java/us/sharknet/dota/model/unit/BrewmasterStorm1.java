...
public final class BrewmasterStorm1 extends NpcUnit {

    private static BrewmasterStorm1 instance;
    ...
    private BrewmasterStorm1() {
        ...
        isAncient = 1;
        isSummoned = 0;
        key = "npc_dota_brewmaster_storm_1";
        level = 7;
        ...
        localizedName = "Brewmaster Strom Spirit Level 1";
    }

    public static BrewmasterStorm1 instance() {
        if( instance == null ){
            instance = new BrewmasterStorm1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterStorm1))
            return false;
        if (object == this)
            return true;
        BrewmasterStorm1 otherObject = (BrewmasterStorm1) object;
