...
public final class BrewmasterStorm2 extends NpcUnit {

    private static BrewmasterStorm2 instance;
    ...
    private BrewmasterStorm2() {
        ...
        isAncient = 1;
        isSummoned = 0;
        key = "npc_dota_brewmaster_storm_2";
        level = 8;
        modelScale = .9;
    ...
    public static BrewmasterStorm2 instance() {
        if( instance == null ){
            instance = new BrewmasterStorm2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof BrewmasterStorm2))
            return false;
        if (object == this)
            return true;
        BrewmasterStorm2 otherObject = (BrewmasterStorm2) object;
