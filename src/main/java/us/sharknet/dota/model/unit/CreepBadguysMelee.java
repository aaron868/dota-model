...
public final class CreepBadguysMelee extends NpcUnit {

    private static CreepBadguysMelee instance;
    ...
    public static CreepBadguysMelee instance() {
        if( instance == null ){
            instance = new CreepBadguysMelee();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepBadguysMelee))
            return false;
        if (object == this)
            return true;
        CreepBadguysMelee otherObject = (CreepBadguysMelee) object;
