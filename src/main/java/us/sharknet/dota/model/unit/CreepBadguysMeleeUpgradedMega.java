...
public final class CreepBadguysMeleeUpgradedMega extends NpcUnit {

    private static CreepBadguysMeleeUpgradedMega instance;
    ...
    private CreepBadguysMeleeUpgradedMega() {
        armorPhysical = 3;
        ...
        healthBarOffset = 120;
        key = "npc_dota_creep_badguys_melee_upgraded_mega";
        level = 1;
        magicalResistance = 0;
        ...
        localizedName = "Dire Mega Melee Creep";
    }

    public static CreepBadguysMeleeUpgradedMega instance() {
        if( instance == null ){
            instance = new CreepBadguysMeleeUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepBadguysMeleeUpgradedMega))
            return false;
        if (object == this)
            return true;
        CreepBadguysMeleeUpgradedMega otherObject = (CreepBadguysMeleeUpgradedMega) object;
