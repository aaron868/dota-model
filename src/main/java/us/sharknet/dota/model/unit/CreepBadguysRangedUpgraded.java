...
public final class CreepBadguysRangedUpgraded extends NpcUnit {

    private static CreepBadguysRangedUpgraded instance;
    ...
    private CreepBadguysRangedUpgraded() {
        armorPhysical = 1;
        ...
        healthBarOffset = 150;
        key = "npc_dota_creep_badguys_ranged_upgraded";
        level = 1;
        magicalResistance = 0;
        ...
        localizedName = "Dire Super Ranged Creep";
    }

    public static CreepBadguysRangedUpgraded instance() {
        if( instance == null ){
            instance = new CreepBadguysRangedUpgraded();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepBadguysRangedUpgraded))
            return false;
        if (object == this)
            return true;
        CreepBadguysRangedUpgraded otherObject = (CreepBadguysRangedUpgraded) object;
