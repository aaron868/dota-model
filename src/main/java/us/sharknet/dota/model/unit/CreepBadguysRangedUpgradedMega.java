...
public final class CreepBadguysRangedUpgradedMega extends NpcUnit {

    private static CreepBadguysRangedUpgradedMega instance;
    ...
    private CreepBadguysRangedUpgradedMega() {
        armorPhysical = 1;
        ...
        localizedName = "Dire Mega Ranged Creep";
    }

    public static CreepBadguysRangedUpgradedMega instance() {
        if( instance == null ){
            instance = new CreepBadguysRangedUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepBadguysRangedUpgradedMega))
            return false;
        if (object == this)
            return true;
        CreepBadguysRangedUpgradedMega otherObject = (CreepBadguysRangedUpgradedMega) object;
