...
public final class CreepGoodguysMeleeUpgraded extends NpcUnit {

    private static CreepGoodguysMeleeUpgraded instance;
    ...
    private CreepGoodguysMeleeUpgraded() {
        armorPhysical = 3;
        ...
        healthBarOffset = 13;
        key = "npc_dota_creep_goodguys_melee_upgraded";
        level = 1;
        magicalResistance = 0;
        ...
        localizedName = "Radiant Super Melee Creep";
    }

    public static CreepGoodguysMeleeUpgraded instance() {
        if( instance == null ){
            instance = new CreepGoodguysMeleeUpgraded();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepGoodguysMeleeUpgraded))
            return false;
        if (object == this)
            return true;
        CreepGoodguysMeleeUpgraded otherObject = (CreepGoodguysMeleeUpgraded) object;
