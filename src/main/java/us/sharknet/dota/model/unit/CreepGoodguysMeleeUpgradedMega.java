...
public final class CreepGoodguysMeleeUpgradedMega extends NpcUnit {

    private static CreepGoodguysMeleeUpgradedMega instance;
    ...
    public static CreepGoodguysMeleeUpgradedMega instance() {
        if( instance == null ){
            instance = new CreepGoodguysMeleeUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepGoodguysMeleeUpgradedMega))
            return false;
        if (object == this)
            return true;
        CreepGoodguysMeleeUpgradedMega otherObject = (CreepGoodguysMeleeUpgradedMega) object;
