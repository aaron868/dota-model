...
public final class CreepGoodguysRangedUpgradedMega extends NpcUnit {

    private static CreepGoodguysRangedUpgradedMega instance;
    ...
    private CreepGoodguysRangedUpgradedMega() {
        armorPhysical = 1;
        ...
        healthBarOffset = 155;
        key = "npc_dota_creep_goodguys_ranged_upgraded_mega";
        level = 1;
        magicalResistance = 0;
        modelScale = 1.12;
        ...
        localizedName = "Radiant Mega Ranged Creep";
    }

    public static CreepGoodguysRangedUpgradedMega instance() {
        if( instance == null ){
            instance = new CreepGoodguysRangedUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof CreepGoodguysRangedUpgradedMega))
            return false;
        if (object == this)
            return true;
        CreepGoodguysRangedUpgradedMega otherObject = (CreepGoodguysRangedUpgradedMega) object;
