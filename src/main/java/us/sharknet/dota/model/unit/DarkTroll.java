...
public final class DarkTroll extends NpcUnit {

    private static DarkTroll instance;
    ...
    public static DarkTroll instance() {
        if( instance == null ){
            instance = new DarkTroll();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof DarkTroll))
            return false;
        if (object == this)
            return true;
        DarkTroll otherObject = (DarkTroll) object;
