...
public final class Eidolon extends NpcUnit {

    private static Eidolon instance;
    ...
    private Eidolon() {
        ...
        localizedName = "Eidolon";
        wearable = 8638;
    }

    public static Eidolon instance() {
        if( instance == null ){
            instance = new Eidolon();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof Eidolon))
            return false;
        if (object == this)
            return true;
        Eidolon otherObject = (Eidolon) object;
