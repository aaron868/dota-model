...
public final class FurionTreantLarge extends NpcUnit {

    private static FurionTreantLarge instance;
    ...
    public static FurionTreantLarge instance() {
        if( instance == null ){
            instance = new FurionTreantLarge();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof FurionTreantLarge))
            return false;
        if (object == this)
            return true;
        FurionTreantLarge otherObject = (FurionTreantLarge) object;
