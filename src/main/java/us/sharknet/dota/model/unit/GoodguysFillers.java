...
public final class GoodguysFillers extends NpcUnit {

    private static GoodguysFillers instance;
    ...
    public static GoodguysFillers instance() {
        if( instance == null ){
            instance = new GoodguysFillers();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysFillers))
            return false;
        if (object == this)
            return true;
        GoodguysFillers otherObject = (GoodguysFillers) object;
