...
public final class GoodguysMeleeRaxBot extends NpcUnit {

    private static GoodguysMeleeRaxBot instance;
    ...
    private GoodguysMeleeRaxBot() {
        ...
        localizedName = "Radiant Bottom Melee Barracks";
    }

    public static GoodguysMeleeRaxBot instance() {
        if( instance == null ){
            instance = new GoodguysMeleeRaxBot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysMeleeRaxBot))
            return false;
        if (object == this)
            return true;
        GoodguysMeleeRaxBot otherObject = (GoodguysMeleeRaxBot) object;
