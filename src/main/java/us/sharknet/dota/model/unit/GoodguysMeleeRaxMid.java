...
public final class GoodguysMeleeRaxMid extends NpcUnit {

    private static GoodguysMeleeRaxMid instance;
    ...
    private GoodguysMeleeRaxMid() {
        ...
        localizedName = "Radiant Mid Melee Barracks";
    }

    public static GoodguysMeleeRaxMid instance() {
        if( instance == null ){
            instance = new GoodguysMeleeRaxMid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysMeleeRaxMid))
            return false;
        if (object == this)
            return true;
        GoodguysMeleeRaxMid otherObject = (GoodguysMeleeRaxMid) object;
