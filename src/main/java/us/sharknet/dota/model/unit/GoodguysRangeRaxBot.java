...
public final class GoodguysRangeRaxBot extends NpcUnit {

    private static GoodguysRangeRaxBot instance;
    ...
    private GoodguysRangeRaxBot() {
        ...
        localizedName = "Radiant Bottom Ranged Barracks";
    }

    public static GoodguysRangeRaxBot instance() {
        if( instance == null ){
            instance = new GoodguysRangeRaxBot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysRangeRaxBot))
            return false;
        if (object == this)
            return true;
        GoodguysRangeRaxBot otherObject = (GoodguysRangeRaxBot) object;
