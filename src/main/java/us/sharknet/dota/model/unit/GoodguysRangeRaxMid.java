...
public final class GoodguysRangeRaxMid extends NpcUnit {

    private static GoodguysRangeRaxMid instance;
    ...
    private GoodguysRangeRaxMid() {
        ...
        localizedName = "Radiant Mid Ranged Barracks";
    }

    public static GoodguysRangeRaxMid instance() {
        if( instance == null ){
            instance = new GoodguysRangeRaxMid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysRangeRaxMid))
            return false;
        if (object == this)
            return true;
        GoodguysRangeRaxMid otherObject = (GoodguysRangeRaxMid) object;
