...
public final class GoodguysRangeRaxTop extends NpcUnit {

    private static GoodguysRangeRaxTop instance;
    ...
    private GoodguysRangeRaxTop() {
        ...
        localizedName = "Radiant Top Ranged Barracks";
    }

    public static GoodguysRangeRaxTop instance() {
        if( instance == null ){
            instance = new GoodguysRangeRaxTop();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysRangeRaxTop))
            return false;
        if (object == this)
            return true;
        GoodguysRangeRaxTop otherObject = (GoodguysRangeRaxTop) object;
