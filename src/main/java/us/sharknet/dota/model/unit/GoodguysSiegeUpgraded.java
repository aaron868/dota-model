...
public final class GoodguysSiegeUpgraded extends NpcUnit {

    private static GoodguysSiegeUpgraded instance;
    ...
    public static GoodguysSiegeUpgraded instance() {
        if( instance == null ){
            instance = new GoodguysSiegeUpgraded();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysSiegeUpgraded))
            return false;
        if (object == this)
            return true;
        GoodguysSiegeUpgraded otherObject = (GoodguysSiegeUpgraded) object;
