...
public final class GoodguysSiegeUpgradedMega extends NpcUnit {

    private static GoodguysSiegeUpgradedMega instance;
    ...
    private GoodguysSiegeUpgradedMega() {
        armorPhysical = 0;
        ...
        healthBarOffset = 160;
        key = "npc_dota_goodguys_siege_upgraded_mega";
        level = 4;
        ...
        localizedName = "Radiant Mega Siege Creep";
    }

    public static GoodguysSiegeUpgradedMega instance() {
        if( instance == null ){
            instance = new GoodguysSiegeUpgradedMega();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysSiegeUpgradedMega))
            return false;
        if (object == this)
            return true;
        GoodguysSiegeUpgradedMega otherObject = (GoodguysSiegeUpgradedMega) object;
