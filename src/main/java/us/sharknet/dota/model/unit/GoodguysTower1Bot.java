...
public final class GoodguysTower1Bot extends NpcUnit {

    private static GoodguysTower1Bot instance;
    ...
    private GoodguysTower1Bot() {
        ...
        localizedName = "Radiant Bottom Tier 1 Tower";
    }

    public static GoodguysTower1Bot instance() {
        if( instance == null ){
            instance = new GoodguysTower1Bot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower1Bot))
            return false;
        if (object == this)
            return true;
        GoodguysTower1Bot otherObject = (GoodguysTower1Bot) object;
