...
public final class GoodguysTower1Mid extends NpcUnit {

    private static GoodguysTower1Mid instance;
    ...
    public static GoodguysTower1Mid instance() {
        if( instance == null ){
            instance = new GoodguysTower1Mid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower1Mid))
            return false;
        if (object == this)
            return true;
        GoodguysTower1Mid otherObject = (GoodguysTower1Mid) object;
