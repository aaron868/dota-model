...
public final class GoodguysTower1Top extends NpcUnit {

    private static GoodguysTower1Top instance;
    ...
    private GoodguysTower1Top() {
        ...
        localizedName = "Radiant Top Tier 1 Tower";
    }

    public static GoodguysTower1Top instance() {
        if( instance == null ){
            instance = new GoodguysTower1Top();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower1Top))
            return false;
        if (object == this)
            return true;
        GoodguysTower1Top otherObject = (GoodguysTower1Top) object;
