...
public final class GoodguysTower2Bot extends NpcUnit {

    private static GoodguysTower2Bot instance;

    private final BackdoorProtection ability1;
    ...
    private GoodguysTower2Bot() {
        ability1 = BackdoorProtection.instance();
        armorPhysical = 22;
        ...
        localizedName = "Radiant Bottom Tier 2 Tower";
    }

    public static GoodguysTower2Bot instance() {
        if( instance == null ){
            instance = new GoodguysTower2Bot();
        }
        return instance;
    }

    public BackdoorProtection getAbility1() {
        return ability1;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower2Bot))
            return false;
        if (object == this)
            return true;
        GoodguysTower2Bot otherObject = (GoodguysTower2Bot) object;
