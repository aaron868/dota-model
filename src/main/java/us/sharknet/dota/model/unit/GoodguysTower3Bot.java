...
public final class GoodguysTower3Bot extends NpcUnit {

    private static GoodguysTower3Bot instance;
    ...
    private GoodguysTower3Bot() {
        ...
        localizedName = "Radiant Bottom Tier 3 Tower";
    }

    public static GoodguysTower3Bot instance() {
        if( instance == null ){
            instance = new GoodguysTower3Bot();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower3Bot))
            return false;
        if (object == this)
            return true;
        GoodguysTower3Bot otherObject = (GoodguysTower3Bot) object;
