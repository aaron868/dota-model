...
public final class GoodguysTower3Mid extends NpcUnit {

    private static GoodguysTower3Mid instance;
    ...
    private GoodguysTower3Mid() {
        ...
        localizedName = "Radiant Mid Tier 3 Tower";
    }

    public static GoodguysTower3Mid instance() {
        if( instance == null ){
            instance = new GoodguysTower3Mid();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower3Mid))
            return false;
        if (object == this)
            return true;
        GoodguysTower3Mid otherObject = (GoodguysTower3Mid) object;
