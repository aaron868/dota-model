...
public final class GoodguysTower3Top extends NpcUnit {

    private static GoodguysTower3Top instance;
    ...
    private GoodguysTower3Top() {
        ...
        localizedName = "Radiant Top Tier 3 Tower";
    }

    public static GoodguysTower3Top instance() {
        if( instance == null ){
            instance = new GoodguysTower3Top();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower3Top))
            return false;
        if (object == this)
            return true;
        GoodguysTower3Top otherObject = (GoodguysTower3Top) object;
