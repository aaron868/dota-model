...
public final class GoodguysTower4 extends NpcUnit {

    private static GoodguysTower4 instance;
    ...
    private GoodguysTower4() {
        ...
        minimapIconSize = 320;
        model = "models/props_structures/tower_good";
        ...
        localizedName = "Radiant Tier 4 Tower";
    }

    public static GoodguysTower4 instance() {
        if( instance == null ){
            instance = new GoodguysTower4();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GoodguysTower4))
            return false;
        if (object == this)
            return true;
        GoodguysTower4 otherObject = (GoodguysTower4) object;
