...
public final class GraniteGolem extends NpcUnit {

    private static GraniteGolem instance;

    private final GraniteGolemHpAura ability1;
    ...
    public static GraniteGolem instance() {
        if( instance == null ){
            instance = new GraniteGolem();
        }
        return instance;
    }

    public GraniteGolemHpAura getAbility1() {
        return ability1;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GraniteGolem))
            return false;
        if (object == this)
            return true;
        GraniteGolem otherObject = (GraniteGolem) object;
