...
public final class GreaterEidolon extends NpcUnit {

    private static GreaterEidolon instance;
    ...
    private GreaterEidolon() {
        ...
        localizedName = "Greater Eidolon";
        wearable = 8638;
    }

    public static GreaterEidolon instance() {
        if( instance == null ){
            instance = new GreaterEidolon();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof GreaterEidolon))
            return false;
        if (object == this)
            return true;
        GreaterEidolon otherObject = (GreaterEidolon) object;
