...
public final class HarpyScout extends NpcUnit {

    private static HarpyScout instance;
    ...
    public static HarpyScout instance() {
        if( instance == null ){
            instance = new HarpyScout();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof HarpyScout))
            return false;
        if (object == this)
            return true;
        HarpyScout otherObject = (HarpyScout) object;
