...
public final class HarpyStorm extends NpcUnit {

    private static HarpyStorm instance;

    private final HarpyStormChainLightning ability1;
    ...
    public static HarpyStorm instance() {
        if( instance == null ){
            instance = new HarpyStorm();
        }
        return instance;
    }

    public HarpyStormChainLightning getAbility1() {
        return ability1;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof HarpyStorm))
            return false;
        if (object == this)
            return true;
        HarpyStorm otherObject = (HarpyStorm) object;
