...
public final class KoboldTunneler extends NpcUnit {

    private static KoboldTunneler instance;
    ...
    public static KoboldTunneler instance() {
        if( instance == null ){
            instance = new KoboldTunneler();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof KoboldTunneler))
            return false;
        if (object == this)
            return true;
        KoboldTunneler otherObject = (KoboldTunneler) object;
