...
public final class LesserEidolon extends NpcUnit {

    private static LesserEidolon instance;
    ...
    public static LesserEidolon instance() {
        if( instance == null ){
            instance = new LesserEidolon();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof LesserEidolon))
            return false;
        if (object == this)
            return true;
        LesserEidolon otherObject = (LesserEidolon) object;
