...
public final class LoneDruidBear3 extends NpcUnit {

    private static LoneDruidBear3 instance;
    ...
    private LoneDruidBear3() {
        ...
        localizedName = "Spirit Bear Level 3";
    }

    public static LoneDruidBear3 instance() {
        if( instance == null ){
            instance = new LoneDruidBear3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof LoneDruidBear3))
            return false;
        if (object == this)
            return true;
        LoneDruidBear3 otherObject = (LoneDruidBear3) object;
