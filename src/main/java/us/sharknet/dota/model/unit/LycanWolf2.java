...
public final class LycanWolf2 extends NpcUnit {

    private static LycanWolf2 instance;
    ...
    private LycanWolf2() {
        ...
        localizedName = "Lycan Wolf Level 2";
    }

    public static LycanWolf2 instance() {
        if( instance == null ){
            instance = new LycanWolf2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof LycanWolf2))
            return false;
        if (object == this)
            return true;
        LycanWolf2 otherObject = (LycanWolf2) object;
