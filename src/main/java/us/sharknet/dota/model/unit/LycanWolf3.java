...
public final class LycanWolf3 extends NpcUnit {

    private static LycanWolf3 instance;
    ...
    private LycanWolf3() {
        ...
        localizedName = "Lycan Wolf Level 3";
    }

    public static LycanWolf3 instance() {
        if( instance == null ){
            instance = new LycanWolf3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof LycanWolf3))
            return false;
        if (object == this)
            return true;
        LycanWolf3 otherObject = (LycanWolf3) object;
