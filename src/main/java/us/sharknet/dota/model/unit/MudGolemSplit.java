...
public final class MudGolemSplit extends NpcUnit {

    private static MudGolemSplit instance;
    ...
    private MudGolemSplit() {
        ...
        localizedName = "Shard Golem";
    }

    public static MudGolemSplit instance() {
        if( instance == null ){
            instance = new MudGolemSplit();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof MudGolemSplit))
            return false;
        if (object == this)
            return true;
        MudGolemSplit otherObject = (MudGolemSplit) object;
