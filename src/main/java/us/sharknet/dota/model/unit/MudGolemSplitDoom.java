...
public final class MudGolemSplitDoom extends NpcUnit {

    private static MudGolemSplitDoom instance;
    ...
    private MudGolemSplitDoom() {
        ...
        localizedName = "Doom Shard";
    }

    public static MudGolemSplitDoom instance() {
        if( instance == null ){
            instance = new MudGolemSplitDoom();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof MudGolemSplitDoom))
            return false;
        if (object == this)
            return true;
        MudGolemSplitDoom otherObject = (MudGolemSplitDoom) object;
