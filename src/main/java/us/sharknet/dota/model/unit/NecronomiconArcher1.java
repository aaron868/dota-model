...
public final class NecronomiconArcher1 extends NpcUnit {

    private static NecronomiconArcher1 instance;
    ...
    private NecronomiconArcher1() {
        ...
        healthBarOffset = 155;
        isSummoned = 1;
        key = "npc_dota_necronomicon_archer_1";
        level = 5;
        ...
        localizedName = "Necronomicon Archer Level 1";
    }

    public static NecronomiconArcher1 instance() {
        if( instance == null ){
            instance = new NecronomiconArcher1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof NecronomiconArcher1))
            return false;
        if (object == this)
            return true;
        NecronomiconArcher1 otherObject = (NecronomiconArcher1) object;
