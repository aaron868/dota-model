...
public final class NecronomiconArcher2 extends NpcUnit {

    private static NecronomiconArcher2 instance;
    ...
    private NecronomiconArcher2() {
        ...
        healthBarOffset = 16;
        isSummoned = 1;
        key = "npc_dota_necronomicon_archer_2";
        level = 5;
        magicalResistance = 4;
        ...
        localizedName = "Necronomicon Archer Level 2";
    }

    public static NecronomiconArcher2 instance() {
        if( instance == null ){
            instance = new NecronomiconArcher2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof NecronomiconArcher2))
            return false;
        if (object == this)
            return true;
        NecronomiconArcher2 otherObject = (NecronomiconArcher2) object;
