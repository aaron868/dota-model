...
public final class NecronomiconWarrior2 extends NpcUnit {

    private static NecronomiconWarrior2 instance;
    ...
    private NecronomiconWarrior2() {
        ...
        localizedName = "Necronomicon Warrior Level 2";
    }

    public static NecronomiconWarrior2 instance() {
        if( instance == null ){
            instance = new NecronomiconWarrior2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof NecronomiconWarrior2))
            return false;
        if (object == this)
            return true;
        NecronomiconWarrior2 otherObject = (NecronomiconWarrior2) object;
