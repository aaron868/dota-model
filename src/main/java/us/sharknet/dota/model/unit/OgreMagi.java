...
public final class OgreMagi extends NpcUnit {

    private static OgreMagi instance;

    private final OgreMagiFrostArmor ability1;
    ...
    private OgreMagi() {
        ability1 = OgreMagiFrostArmor.instance();
        armorPhysical = 0;
        ...
        healthBarOffset = 210;
        isNeutralUnitType = 1;
        key = "npc_dota_neutral_ogre_magi";
        level = 3;
        modelScale = .9;
    ...
    public OgreMagiFrostArmor getAbility1() {
        return ability1;
    }
