...
public final class OgreMauler extends NpcUnit {

    private static OgreMauler instance;
    ...
    public static OgreMauler instance() {
        if( instance == null ){
            instance = new OgreMauler();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof OgreMauler))
            return false;
        if (object == this)
            return true;
        OgreMauler otherObject = (OgreMauler) object;
