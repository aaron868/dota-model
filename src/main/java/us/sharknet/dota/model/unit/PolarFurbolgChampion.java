...
public final class PolarFurbolgChampion extends NpcUnit {
    ...
    public static PolarFurbolgChampion instance() {
        if( instance == null ){
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof PolarFurbolgChampion))
            return false;
        if (object == this)
            return true;
        PolarFurbolgChampion otherObject = (PolarFurbolgChampion) object;
