...
public final class RockGolem extends NpcUnit {

    private static RockGolem instance;
    ...
    public static RockGolem instance() {
        if( instance == null ){
            instance = new RockGolem();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof RockGolem))
            return false;
        if (object == this)
            return true;
        RockGolem otherObject = (RockGolem) object;
