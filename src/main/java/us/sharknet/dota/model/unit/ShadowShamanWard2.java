...
public final class ShadowShamanWard2 extends NpcUnit {

    private static ShadowShamanWard2 instance;
    ...
    private ShadowShamanWard2() {
        ...
        hasInventory = 0;
        healthBarOffset = 200;
        key = "npc_dota_shadow_shaman_ward_2";
        level = 3;
        magicalResistance = 0;
        ...
        localizedName = "Serpent Ward Level 2";
        wearable = 8371;
    }

    public static ShadowShamanWard2 instance() {
        if( instance == null ){
            instance = new ShadowShamanWard2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof ShadowShamanWard2))
            return false;
        if (object == this)
            return true;
        ShadowShamanWard2 otherObject = (ShadowShamanWard2) object;
