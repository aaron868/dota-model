...
public final class ShadowShamanWard3 extends NpcUnit {

    private static ShadowShamanWard3 instance;
    ...
    private ShadowShamanWard3() {
        ...
        hasInventory = 0;
        healthBarOffset = 200;
        key = "npc_dota_shadow_shaman_ward_3";
        level = 3;
        magicalResistance = 0;
        modelScale = 1.15;
        ...
        localizedName = "Serpent Ward Level 3";
        wearable = 8371;
    }

    public static ShadowShamanWard3 instance() {
        if( instance == null ){
            instance = new ShadowShamanWard3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof ShadowShamanWard3))
            return false;
        if (object == this)
            return true;
        ShadowShamanWard3 otherObject = (ShadowShamanWard3) object;
