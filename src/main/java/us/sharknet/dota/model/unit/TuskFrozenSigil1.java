...
public final class TuskFrozenSigil1 extends NpcUnit {

    private static TuskFrozenSigil1 instance;
    ...
    private TuskFrozenSigil1() {
        ...
        localizedName = "Frozen Sigil Level 1";
        wearable = 8640;
    }

    public static TuskFrozenSigil1 instance() {
        if( instance == null ){
            instance = new TuskFrozenSigil1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof TuskFrozenSigil1))
            return false;
        if (object == this)
            return true;
        TuskFrozenSigil1 otherObject = (TuskFrozenSigil1) object;
