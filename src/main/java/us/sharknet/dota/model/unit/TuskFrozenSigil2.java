...
public final class TuskFrozenSigil2 extends NpcUnit {

    private static TuskFrozenSigil2 instance;
    ...
    private TuskFrozenSigil2() {
        ...
        followRange = 250;
        key = "npc_dota_tusk_frozen_sigil2";
        level = 0;
        magicalResistance = 0;
        ...
        localizedName = "Frozen Sigil Level 2";
        wearable = 8640;
    }

    public static TuskFrozenSigil2 instance() {
        if( instance == null ){
            instance = new TuskFrozenSigil2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof TuskFrozenSigil2))
            return false;
        if (object == this)
            return true;
        TuskFrozenSigil2 otherObject = (TuskFrozenSigil2) object;
