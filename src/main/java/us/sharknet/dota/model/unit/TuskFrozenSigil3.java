...
public final class TuskFrozenSigil3 extends NpcUnit {

    private static TuskFrozenSigil3 instance;
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof TuskFrozenSigil3))
            return false;
        if (object == this)
            return true;
        TuskFrozenSigil3 otherObject = (TuskFrozenSigil3) object;
