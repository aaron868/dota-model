...
public final class UnitTombstone2 extends NpcUnit {

    private static UnitTombstone2 instance;
    ...
    private UnitTombstone2() {
        ...
        localizedName = "Tombstone Level 2";
        wearable = 8630;
    }

    public static UnitTombstone2 instance() {
        if( instance == null ){
            instance = new UnitTombstone2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof UnitTombstone2))
            return false;
        if (object == this)
            return true;
        UnitTombstone2 otherObject = (UnitTombstone2) object;
