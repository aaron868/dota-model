...
public final class UnitTombstone3 extends NpcUnit {

    private static UnitTombstone3 instance;
    ...
    private UnitTombstone3() {
        ...
        localizedName = "Tombstone Level 3";
        wearable = 8630;
    }

    public static UnitTombstone3 instance() {
        if( instance == null ){
            instance = new UnitTombstone3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof UnitTombstone3))
            return false;
        if (object == this)
            return true;
        UnitTombstone3 otherObject = (UnitTombstone3) object;
