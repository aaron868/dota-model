...
public final class UnitTombstone4 extends NpcUnit {

    private static UnitTombstone4 instance;
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof UnitTombstone4))
            return false;
        if (object == this)
            return true;
        UnitTombstone4 otherObject = (UnitTombstone4) object;
