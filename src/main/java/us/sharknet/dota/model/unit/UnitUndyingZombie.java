...
public final class UnitUndyingZombie extends NpcUnit {

    private static UnitUndyingZombie instance;
    ...
    public static UnitUndyingZombie instance() {
        if( instance == null ){
            instance = new UnitUndyingZombie();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof UnitUndyingZombie))
            return false;
        if (object == this)
            return true;
        UnitUndyingZombie otherObject = (UnitUndyingZombie) object;
