...
public final class VenomancerPlagueWard1 extends NpcUnit {

    private static VenomancerPlagueWard1 instance;
    ...
    private VenomancerPlagueWard1() {
        ...
        hasInventory = 0;
        healthBarOffset = 170;
        key = "npc_dota_venomancer_plague_ward_1";
        level = 1;
        magicalResistance = 0;
        modelScale = .8;
        ...
        localizedName = "Plague Ward Level 1";
    }

    public static VenomancerPlagueWard1 instance() {
        if( instance == null ){
            instance = new VenomancerPlagueWard1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof VenomancerPlagueWard1))
            return false;
        if (object == this)
            return true;
        VenomancerPlagueWard1 otherObject = (VenomancerPlagueWard1) object;
