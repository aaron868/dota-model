...
public final class VenomancerPlagueWard3 extends NpcUnit {

    private static VenomancerPlagueWard3 instance;
    ...
    private VenomancerPlagueWard3() {
        ...
        hasInventory = 0;
        healthBarOffset = 17;
        key = "npc_dota_venomancer_plague_ward_3";
        level = 1;
        magicalResistance = 0;
        ...
        localizedName = "Plague Ward Level 3";
    }

    public static VenomancerPlagueWard3 instance() {
        if( instance == null ){
            instance = new VenomancerPlagueWard3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof VenomancerPlagueWard3))
            return false;
        if (object == this)
            return true;
        VenomancerPlagueWard3 otherObject = (VenomancerPlagueWard3) object;
