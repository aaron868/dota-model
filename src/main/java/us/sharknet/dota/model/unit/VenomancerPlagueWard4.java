...
public final class VenomancerPlagueWard4 extends NpcUnit {

    private static VenomancerPlagueWard4 instance;
    ...
    private VenomancerPlagueWard4() {
        ...
        hasInventory = 0;
        healthBarOffset = 170;
        key = "npc_dota_venomancer_plague_ward_4";
        level = 1;
        magicalResistance = 0;
        ...
        localizedName = "Plague Ward Level 4";
    }

    public static VenomancerPlagueWard4 instance() {
        if( instance == null ){
            instance = new VenomancerPlagueWard4();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof VenomancerPlagueWard4))
            return false;
        if (object == this)
            return true;
        VenomancerPlagueWard4 otherObject = (VenomancerPlagueWard4) object;
