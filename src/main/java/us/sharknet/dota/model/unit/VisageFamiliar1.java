...
public final class VisageFamiliar1 extends NpcUnit {

    private static VisageFamiliar1 instance;
    ...
    private VisageFamiliar1() {
        ...
        localizedName = "Familiar 1";
        wearable = 6;
    }

    public static VisageFamiliar1 instance() {
        if( instance == null ){
            instance = new VisageFamiliar1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof VisageFamiliar1))
            return false;
        if (object == this)
            return true;
        VisageFamiliar1 otherObject = (VisageFamiliar1) object;
