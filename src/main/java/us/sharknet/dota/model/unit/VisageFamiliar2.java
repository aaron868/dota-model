...
public final class VisageFamiliar2 extends NpcUnit {

    private static VisageFamiliar2 instance;
    ...
    private VisageFamiliar2() {
        ...
        localizedName = "Familiar 2";
        wearable = 6;
    }

    public static VisageFamiliar2 instance() {
        if( instance == null ){
            instance = new VisageFamiliar2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof VisageFamiliar2))
            return false;
        if (object == this)
            return true;
        VisageFamiliar2 otherObject = (VisageFamiliar2) object;
