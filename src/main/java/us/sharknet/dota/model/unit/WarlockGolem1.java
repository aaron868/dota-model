...
public final class WarlockGolem1 extends NpcUnit {

    private static WarlockGolem1 instance;
    ...
    private WarlockGolem1() {
        ...
        localizedName = "Warlock Golem Level 1";
        wearable = 8362;
    }

    public static WarlockGolem1 instance() {
        if( instance == null ){
            instance = new WarlockGolem1();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof WarlockGolem1))
            return false;
        if (object == this)
            return true;
        WarlockGolem1 otherObject = (WarlockGolem1) object;
