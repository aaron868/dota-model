...
public final class WarlockGolem3 extends NpcUnit {

    private static WarlockGolem3 instance;
    ...
    private WarlockGolem3() {
        ...
        localizedName = "Warlock Golem Level 3";
        wearable = 8362;
    }

    public static WarlockGolem3 instance() {
        if( instance == null ){
            instance = new WarlockGolem3();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof WarlockGolem3))
            return false;
        if (object == this)
            return true;
        WarlockGolem3 otherObject = (WarlockGolem3) object;
