...
public final class WarlockGolemScepter2 extends NpcUnit {

    private static WarlockGolemScepter2 instance;
    ...
    private WarlockGolemScepter2() {
        ...
        isAncient = 1;
        isSummoned = 1;
        key = "npc_dota_warlock_golem_scepter_2";
        ...
        localizedName = "Warlock Scepter Golem Level 2";
        wearable = 8362;
    }

    public static WarlockGolemScepter2 instance() {
        if( instance == null ){
            instance = new WarlockGolemScepter2();
        }
        return instance;
    }
    ...
    public boolean equals(final Object object) {
        if (!(object instanceof WarlockGolemScepter2))
            return false;
        if (object == this)
            return true;
        WarlockGolemScepter2 otherObject = (WarlockGolemScepter2) object;
